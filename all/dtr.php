        ...
        <div class="col mt-2">
            <div class="card" style="width: 100%;">
                <div class="card-header">
                    <div class="row">
                        <div class="col">
                            <h1>IT Department DTR</h1>
                        </div>
                        <div class="col">
                            <form method="POST" action="dtrdb.php" id="searchForm">
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="dtrdb.php" enctype="multipart/form-data">
    <div class="mb-3">
    ...
    <div class="mb-3">
        <label for="schoolYear" class="form-label">Mastery</label>
        <input type="text" class="form-control" id="mastery" name="mastery" placeholder="Enter Mastery" required>
    </div>
