...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO makeupdb (professorname, faculty, monthh, schoolyear, pic) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $professorname, $faculty, $monthh, $schoolyear, $targetFile);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['search'])) {
    ...
    $searchQuery = " WHERE professorname LIKE '%$search%' OR faculty LIKE '%$search%' OR monthh LIKE '%$search%' OR schoolyear LIKE '%$search%'";
}

// Construct the SQL query to fetch data based on the search query
$sql = "SELECT * FROM makeupdb" . $searchQuery . " LIMIT 5";
            ...
            <div class='modal-dialog modal-lg modal-dialog-centered'>
                <div class='modal-content'>
                    ...
                    <div class='modal-body'>
                        ...
                        <div class='mb-3'>
                            <strong>Month:</strong> " . $row["monthh"] . "
                        </div>
                        <div class='mb-3'>
                        ...
                        <div class='text-center'>
                            <button type='button' class='btn btn-danger'>
                                <a href='deletemakeup.php?deleteid=".$row["id"]."' class='text-white text-decoration-none'>Delete</a>
                            </button>
