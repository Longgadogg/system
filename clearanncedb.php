...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO clearancedb (professorname, faculty, pic) VALUES ( ?, ?, ?)");
...
$sql = "SELECT * FROM clearancedb" . $searchQuery . " LIMIT 5";
                    ...
                    <div class='modal-body'>
                        ...
                        <div class='text-center'>
                            <button type='button' class='btn btn-danger'>
                                <a href='deleteclearance.php?deleteid=".$row["id"]."' class='text-white text-decoration-none'>Delete</a>
                            </button>
