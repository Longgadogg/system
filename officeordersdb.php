...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO officeordersdb (professorname, faculty, pic) VALUES ( ?, ?, ?)");
    $stmt->bind_param("sss", $professorname, $faculty ,$targetFile);
    ...
    header("Location: officeorders.php");
...
$sql = "SELECT * FROM officeordersdb" . $searchQuery . " LIMIT 5";
                    ...
                    <div class='modal-body'>
                        ...
                        <div class='text-center'>
                            <button type='button' class='btn btn-danger'>
                                <a href='deleteofficeorders.php?deleteid=".$row["id"]."' class='text-white text-decoration-none'>Delete</a>
                            </button>
