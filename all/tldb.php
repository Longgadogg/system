...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO tldb (professorname, semester, schoolyear, pic) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssss", $professorname, $semester, $schoolyear, $targetFile);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['search'])) {
    ...
    $searchQuery = " WHERE professorname LIKE '%$search%' OR semester LIKE '%$search%' OR schoolyear LIKE '%$search%'";
}
