...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="schoolYear" name="schoolyear" placeholder="" required>
    </div>
    <div class="mb-3">
        <label for="schoolYear" class="form-label">Course <Title></Title></label>
        <input type="text" class="form-control" id="schoolYear" name="schoolyear" placeholder="" required>
    </div>
    <div class="mb-3">
        <label for="schoolYear" class="form-label">Credir Units</label>
        <input type="text" class="form-control" id="schoolYear" name="schoolyear" placeholder="" required>
    </div>
    <div class="mb-3">
        <label for="schoolYear" class="form-label">Lec/Lab Hrs</label>
        <input type="text" class="form-control" id="schoolYear" name="schoolyear" placeholder="" required>
    </div>  
    <div class="mb-3">
        <label for="schoolYear" class="form-label">Weeks</label>
        <input type="text" class="form-control" id="schoolYear" name="schoolyear" placeholder="" required>
    </div>
