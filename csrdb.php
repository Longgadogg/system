...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO csrdb (professorname, faculty, pic) VALUES ( ?, ?, ?)");
                    ...
                    <div class='modal-body'>
                        ...
                        <div class='text-center'>
                            <button type='button' class='btn btn-danger'>
                                <a href='deletecsr.php?deleteid=".$row["id"]."' class='text-white text-decoration-none'>Delete</a>
                            </button>
