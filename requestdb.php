...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO requestdb (professorname, faculty, request, pic) VALUES ( ?, ?, ?, ?)");
    $stmt->bind_param("ssss", $professorname, $faculty, $request ,$targetFile);
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset ($_POST['search'])) {
    ...
    $searchQuery = " WHERE professorname LIKE '%$search%' OR faculty LIKE '%$search%'";
}

// Construct the SQL query to fetch data based on the search query
$sql = "SELECT * FROM requestdb" . $searchQuery . " LIMIT 5";
            ...
            <div class='modal-dialog modal-lg modal-dialog-centered'>
                <div class='modal-content'>
                    ...
                    <div class='modal-body'>
                        ...
                        <div class='mb-3'>
                            <strong>Request:</strong> " . $row["request"] . "
                        </div>
                        
                        <div class='text-center'>
                            <button type='button' class='btn btn-danger'>
                                <a href='deleterequest.php?deleteid=".$row["id"]."' class='text-white text-decoration-none'>Delete</a>
                            </button>
